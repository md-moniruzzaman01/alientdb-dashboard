...
const PurchesProductEdit = ({ id }) => {
    ...
    useEffect(() => {
        fetch(`https://alientbd-servar.onrender.com/product/${id}`, {}).then(res => res.json()).then(data => {
            setProductEdit(data)
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch('https://alientbd-servar.onrender.com/purches-update', {
            method: 'POST',
            headers: {
    ...
    // }, [])
    // https://alientbd-servar.onrender.com/
